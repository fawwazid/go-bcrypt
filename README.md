...
**Note:** Even passwords shorter than 72 bytes are pre-hashed, which means they are also limited to 256 bits of entropy, though this is still more than sufficient for password security.
