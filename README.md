...
2. You cannot use this library to verify passwords that were originally hashed with standard bcrypt (without pre-hashing).
3. If migrating from another bcrypt library, you will need to rehash all passwords.
